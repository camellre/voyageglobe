  ...
  return (
    <article className={style.container}>
      ...
      <p className={style.text}>
        ...
        affecting their lifestyle. In these Citizenship by Investment projects,
        there is no need to give up your original nationality. Without language
        and residence requirements, you can legally obtain a second citizenship
        and a new passport in a short time.
      </p>
